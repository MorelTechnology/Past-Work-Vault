...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'ExecuteJAM_Logging_SSIS', 
		...
		@command=N'/ISSERVER "\"\SSISDB\JAMS_Logging\JAMS_Logs\LogJamsHistory.dtsx\"" /SERVER BIDEVETL01 /ENVREFERENCE 141 /Par "\"$ServerOption::LOGGING_LEVEL(Int16)\"";1 /Par "\"$ServerOption::SYNCHRONIZED(Boolean)\"";True /CALLERINFO SQLAGENT /REPORTING E', 
