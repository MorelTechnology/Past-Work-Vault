...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'WinsDataLoad', 
		...
		@command=N'/ISSERVER "\"\SSISDB\Fairmont_WINS\Fairmont_WINS\WinsDataLoad.dtsx\"" /SERVER BIUATETL01 /X86 /ENVREFERENCE 121 /Par "\"$ServerOption::LOGGING_LEVEL(Int16)\"";1 /Par "\"$ServerOption::SYNCHRONIZED(Boolean)\"";True /CALLERINFO SQLAGENT /REPORTING E', 
