...
/*
Script Name: C:\ProdTeamWork\Operations\SSIS\ePAM\Database\ePAM
Generated From Catalog Instance: BIQAETL01
Catalog Name: SSISDB
Folder Name: ePAM
Project Name: ePAM
Reference Name: ePAM/ePAM_Env
...
*/
 ...
 -- SSISDB\ePAM\ePAM\[.|ePAM/ePAM_Env]


--print 'Script Name: C:\ProdTeamWork\Operations\SSIS\ePAM\Database\ePAM
--Generated From Catalog Instance: BIQAETL01
--Catalog Name: SSISDB
--Folder Name: ePAM
--Project Name: ePAM
...
print '------------------------------------------------------------'
print ''
print 'Reference SSISDB\ePAM\ePAM\[.|ePAM/ePAM_Env]'
...
If Not Exists(Select * 
              ...
              Where cf.name = N'ePAM'
                And cp.name = N'ePAM'
                And er.environment_name = N'ePAM_Env'
                And er.environment_folder_name Is NULL)
 begin
  print ' - Creating Reference SSISDB\ePAM\ePAM\[.|ePAM/ePAM_Env]'
  ...
  Exec [SSISDB].[catalog].[create_environment_reference] 
     ...
     , @reference_type = R 
  print ' - Reference SSISDB\ePAM\ePAM\[.|ePAM/ePAM_Env] created'
 end
else print ' - Reference SSISDB\ePAM\ePAM\[.|ePAM/ePAM_Env] already exists.'
go
