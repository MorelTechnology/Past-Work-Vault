...
Declare @FFCS_TIGGLRecon  sql_variant = N'\\mansan02\batchtest$\ePAM\TIGGLRecon.txt'

-- Environment Variable EPAM\EPAM_Env\FFCS_TIGIERecon
Declare @FFCS_TIGIERecon sql_variant = N'\\mansan02\batchtest$\ePAM\TIGIERecon.txt'

-- Environment Variable EPAM\EPAM_Env\FFCS_TIGPosRecon
Declare @FFCS_TIGPosRecon sql_variant = N'\\mansan02\batchtest$\ePAM\TIGPosRecon.txt'


-- EPAM_Env ENVIRONMENT VARIABLE VALUES --

 -- Environment Variable EPAM\EPAM_Env\CS_CMS_Reporting
Declare @CS_CMS_Reporting sql_variant = N'Data Source= Testsql01;Initial Catalog=cms_reporting;Provider=SQLNCLI11.1;Integrated Security=SSPI;Auto Translate=False;'


-----------------------------

/*
Script Name: C:\Users\rkasu\Desktop\EPAMEnvironmentScript\EPAM\4_BIQAETL01_SSISDB_EPAM_EPAM_Env.environment.sql
...
print 'Script Name: C:\Users\rkasu\Desktop\EPAMEnvironmentScript\EPAM\4_BIQAETL01_SSISDB_EPAM_EPAM_Env.environment.sql
Generated From Catalog Instance: BIQAETL01
Catalog Name: SSISDB
Folder Name: EPAM
Environment Name: EPAM_Env
