...
Declare @FFCS_TIGGLRecon  sql_variant = N'\\mansan02\batchdev$\ePAM\TIGGLRecon.txt'

-- Environment Variable EPAM\EPAM_Env\FFCS_TIGIERecon
Declare @FFCS_TIGIERecon sql_variant = N'\\mansan02\batchdev$\ePAM\TIGIERecon.txt'

-- Environment Variable EPAM\EPAM_Env\FFCS_TIGPosRecon
Declare @FFCS_TIGPosRecon sql_variant = N'\\mansan02\batchdev$\ePAM\TIGPosRecon.txt'
