...
Declare @ArchirveDirectory_0 sql_variant = N'\\MANSAN02\BATCHUAT$\CFI\CFIGLFILES\HISTORY'

-- Environment Variable CFIGLFILES\ENV_CFIGLFILES\CFI_CaseReserveFile
Declare @CFI_CaseReserveFile_1 sql_variant = N'\\MANSAN02\BATCHUAT$\CFI\CFIGLFILES\CFICaseReserves.txt'
...
Declare @CFI_FileSummary_3 sql_variant = N'\\MANSAN02\BATCHUAT$\CFI\CFIGLFILES\CFIFileSummary.txt'

-- Environment Variable CFIGLFILES\ENV_CFIGLFILES\CFI_Paids
Declare @CFI_Paids_4 sql_variant = N'\\MANSAN02\BATCHUAT$\CFI\CFIGLFILES\CFIPaids.txt'

-- Environment Variable CFIGLFILES\ENV_CFIGLFILES\CFI_QuarterSummaryFile
Declare @CFI_QuarterSummaryFile_5 sql_variant = N'\\MANSAN02\BATCHUAT$\CFI\CFIGLFILES\CFIQuarterSummary.txt'

-- Environment Variable CFIGLFILES\ENV_CFIGLFILES\HomeDirectory
Declare @HomeDirectory_6 sql_variant = N'\\MANSAN02\BATCHUAT$\CFI\CFIGLFILES'

-- Environment Variable CFIGLFILES\ENV_CFIGLFILES\RS_ReportingCon
Declare @RS_ReportingCon_7 sql_variant = N'Data Source=DWUAT;Initial Catalog=RS_Reporting;Provider=SQLNCLI11.1;Integrated Security=SSPI;Auto Translate=False;'
