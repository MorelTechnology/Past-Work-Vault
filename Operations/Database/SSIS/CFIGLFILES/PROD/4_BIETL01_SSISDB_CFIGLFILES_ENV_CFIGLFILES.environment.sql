...
Declare @ArchirveDirectory_0 sql_variant = N'\\MANSAN02\BATCH$\CFI\CFIGLFILES\HISTORY'
...
Declare @RS_ReportingCon_7 sql_variant = N'Data Source=DWProd;Initial Catalog=RS_Reporting;Provider=SQLNCLI11.1;Integrated Security=SSPI;Auto Translate=False;'
...
print 'Script Name: H:\My SQL Code\Deployment Scripts\BIETL01\CFIGLFILES\\4_BIDEVETL01_SSISDB_CFIGLFILES_ENV_CFIGLFILES.environment.sql
Generated From Catalog Instance: BIDEVETL01
Catalog Name: SSISDB
Folder Name: CFIGLFILES
Environment Name: ENV_CFIGLFILES
