...
/****** Object:  StoredProcedure [dbo].[rpt_Claims]    Script Date: 02/04/2016 08:03:42 ******/
SET ANSI_NULLS ON
GO
...
-- Description:	Gets Authority Guideline Group 4 Items
-- =============================================
CREATE PROCEDURE [dbo].[rpt_Claims]
