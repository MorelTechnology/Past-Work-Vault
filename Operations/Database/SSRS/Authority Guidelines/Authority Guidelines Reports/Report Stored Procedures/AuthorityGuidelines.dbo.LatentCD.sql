...
/****** Object:  StoredProcedure [dbo].[rpt_LatentCD]    Script Date: 02/04/2016 08:02:25 ******/
SET ANSI_NULLS ON
GO
...
-- Description:	Gets Authority Guideline Group 3 Items
-- =============================================
CREATE PROCEDURE [dbo].[rpt_LatentCD]
