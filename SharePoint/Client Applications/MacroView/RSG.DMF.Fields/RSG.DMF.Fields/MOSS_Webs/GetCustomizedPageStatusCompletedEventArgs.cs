...
namespace RSG.DMF.Fields.MOSS_Webs
{
	...
	public class GetCustomizedPageStatusCompletedEventArgs : AsyncCompletedEventArgs
	{
		...
		internal GetCustomizedPageStatusCompletedEventArgs(object[] results, Exception exception, bool cancelled, object userState) : base(exception, cancelled, userState)
		{
