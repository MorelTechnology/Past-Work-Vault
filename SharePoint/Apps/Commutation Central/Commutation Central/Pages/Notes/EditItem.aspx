...
<asp:Content ContentPlaceHolderId="PlaceHolderAdditionalPageHead" runat="server">
    ...
    <script type="text/javascript" src="../../Scripts/Notes/EditItem.js"></script>
            ...
            <td class="formMainContent">
                ...
                <div class="contentRow">
                    <table class="childTable" style="width: 100%">
                        ...
                        <tr>
                            <td class="contentCell"><h4>Counterparty Name:</h4></td>
                            <td class="contentCell"><label id="counterpartyName" /></td>
                            <td class="contentCell"><h4>Note Entry Type:</h4></td>
                            <td class="contentCell"><label id="noteEntryType" /></td>
                        </tr>
                        <tr>
                            <td class="contentCell"><h4>Author:</h4></td>
                            <td class="contentCell"><label id="author" /></td>
                            <td class="contentCell"><h4>Entry Date:</h4></td>
                            <td class="contentCell"><label id="entryDate" /></td>
                        </tr>
                    </table>
                </div>
                <div class="contentRow">&nbsp;</div>
                ...
                <div class="contentRow">
                    <table class="childTable" style="width: 100%">
                        ...
                        <tr>
                            <td class="contentCell">
                                <input type="file" id="getNoteFile" style="width: 400px;" onchange="FileUploadFieldChanged('Note Document', 'getNoteFile', 'Note')" class="fileUpload" /><br />
                            </td>
                        </tr>
                        <tr>
                            <td class="contentCell">
                                <table id="noteDocuments" class="childTable display">
                                    <thead>
                                        <tr>
