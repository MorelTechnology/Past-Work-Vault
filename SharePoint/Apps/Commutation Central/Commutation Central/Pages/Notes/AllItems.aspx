...
<asp:Content ContentPlaceHolderId="PlaceHolderAdditionalPageHead" runat="server">
    ...
    <script type="text/javascript" src="../../Scripts/Notes/AllItems.js"></script>
</asp:Content>
...
<asp:Content ContentPlaceHolderId="PlaceHolderMain" runat="server">
    ...
    <div style="display:table; width: 100%">
        <p>
            <a title="Add a new item to this list or library." class="ms-heroCommandLink" id="idHomePageNewItem" onclick='NewNote()' href="javascript:void(0)"><span class="ms-list-addnew-imgSpan20"><img class="ms-list-addnew-img20" id="idHomePageNewItem-img" src="/_layouts/15/images/spcommon.png?rev=23"></span><span>new item</span></a>
        </p>
        ...
        <table id="notes" class="display">
            <thead>
                <tr>
                    ...
                    <th style="text-align: left">Project:Counterparty Name</th>
                    <th style="text-align: left">Project:Project ID</th>
