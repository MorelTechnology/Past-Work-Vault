(function () {
    ...
    angular
        ...
        .factory('activityDocumentItemFactory', ['baseItemFactory', '$q', '$http', 'Upload', '$uibModal', 'sharedProperties', function (baseService, $q, $http, Upload, $uibModal, sharedProperties) {
            var listEndPoint = '/_api/web/lists';
            var listName = 'Commutation Documents';
            var selectFields = '*,Activity/ID,Activity/Description,Author/Title,Editor/Title,Project/ID';
            var expandFields = "Activity,File,Author,Editor,Project";
            var itemType = 'SP.Data.Commutation_x0020_DocumentsListItem';
            var contentTypeId = '0x010008DD58691A864D73907EE222820B20DF';
            ...
            var uploadFile = function (file, projectId, activityId) {
                ...
                .then(function (result) {
                    ...
                    deferred.notify({ percentComplete: 0, action: "Creating activity documents subfolder...", inProgress: true });
                    createFolder(projectId + "/Activity Documents")
                    .then(function (result) {
                        deferred.notify({ percentComplete: 0, action: "Activity documents subfolder created successfully", inProgress: true });
                        deferred.notify({ percentComplete: 0, action: "Uploading document...", inProgress: true });
                        baseService.digest()
                        .then(function (digest) {
                            addNew(file, projectId + "/Activity Documents", digest)
                            .then(function (result) {
                                ...
                                .then(function (result) {
                                    ...
                                    result.data.d.ActivityId = activityId;
