(function () {
    ...
    angular
        ...
        .factory('dealPriorityItemFactory', ['baseItemFactory', function (baseService) {
            var listEndPoint = '/_api/web/lists';
            var listName = 'Deal Priority Lookup';
            var selectFields = 'ID,DealPriorityName';
            var itemType = 'SP.Data.Deal_x0020_Priority_x0020_LookupListItem';
            var getAll = function () {
            ...
            var addNew = function (item) {
                var data = {
                    ...
                    DealPriorityName: item.DealPriorityName
                };
