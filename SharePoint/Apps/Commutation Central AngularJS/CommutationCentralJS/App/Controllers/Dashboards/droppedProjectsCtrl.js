(function () {
    ...
    angular
        ...
        .controller('droppedProjectsCtrl', ['$scope', 'projectItemFactory', 'DTOptionsBuilder', 'DTColumnDefBuilder', '$uibModal', 'sharedProperties', 'projectFinancialsFactory',
            function ($scope, itemFactory, DTOptionsBuilder, DTColumnDefBuilder, $uibModal, sharedProperties, projectFinancialsFactory) {
                ...
                $scope.getItems = function () {
                    $scope.inProgress = true;
                    itemFactory.getAll("CommutationStatus/CommutationStatusName eq 'Dropped'")
